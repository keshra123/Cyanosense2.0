...
path, dirs, files = next(os.walk("/Users/keshra123/Results/May 2nd Location 1 Lake Chapman/May2ndReadings1"))
...
for i in range(file_count):
    temp_df = pd.read_csv("/Users/keshra123/Results/May 2nd Location 1 Lake Chapman/May2ndReadings1/"+files[i], sep='delimiter', header=None, engine='python')
    #print(i)
    res = []
    res1 = [] 
    for j in range(len(temp_df)):  
        ...
        #Down Sensor (Downwelling) 
            ...
            #res3 =[]
            #for i in range(len(df3)):
            #    res3.append(1/ int(df3[i]))
            res3 = [eval(i) for i in df4]
            #res3 = [pow(int(i),-1) for i in df4]
            print(res3)
...
plt.plot(UpSensorWavelengths, upReadings[10],color='r',label=upTimeStamp[10])
plt.plot(DwnSensorWavelengths, dwnReadings[10],color='g',label=dwnTimeStamp[10])
"""
...
Epanel1 = dwnReadings[1]
Epanel2 = dwnReadings[2]
Eup = dwnReadings[6]
Eup1 = dwnReadings[10]
Eup2 = dwnReadings[3]
Edwn = upReadings[6]
