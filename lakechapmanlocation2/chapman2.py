...
path, dirs, files = next(os.walk('/Users/keshra123/Results/lakechapmanlocation2/ChapmanLocation2/'))
...
for i in range(file_count):
    temp_df = pd.read_csv('/Users/keshra123/Results/lakechapmanlocation2/ChapmanLocation2/'+files[i], sep='delimiter', header=None, engine='python')
    res = []
    res1 = [] 
